...
public class GigasecondTest
{
    ...
    {
        var gs = new Gigasecond.Gigasecond(new DateTime(2011, 4, 25));
    ...
    {
        var gs = new Gigasecond.Gigasecond(new DateTime(1977, 6, 13));
    ...
    {
        var gs = new Gigasecond.Gigasecond(new DateTime(1959, 7, 19));
